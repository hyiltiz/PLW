...
switch nameS
    ...
    case 'STAI'
        ...
        ques.instr = [repmat({'下面列出的是一些人们常常用来描述他们自己的陈述，\n\n请阅读每一个陈述，然后键盘数字键来表示你现在最恰当的感觉，\n\n也就是你此时此刻最恰当的感觉。没有对或错的回答，\n\n不要对任何一个陈述花太多的时间去考虑，但所给的回答应该是你现在最恰当的感觉。'},numel(ques.items)/2,1); repmat({'下面列出的是人们常常用来描述他们自己的一些陈述，\n\n请阅读每一个陈述后，然后通过键盘数字键来表示你经常的感觉。没有对或错的回答。\n\n不要对任何一个陈述花太多的时间去考虑，但所给均回答应该是你平常所感觉到的。'},numel(ques.items)/2,1)];
