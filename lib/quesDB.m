...
%         ques.target = repmat({''}, numel(ques.items),1);
    ...
    case 'LSAS'
        ...
        ques.title = {1, '本量表评估不同情景下社交恐怖对您生活的影响。请仔细阅读每个情景，并回答两个相关的问题。\n\n第一个问题关于您在该情景下感到焦虑或恐惧的程度。第二个问题关于您逃避该情景的频率。\n\n如果问题中情景您平时不会经历，请您想象该情景。'};
