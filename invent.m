instr = '作答说明：您好！下列是有关您在不同情境下可能会有的想法和感受。对每一题目，请选择与您情况最符合的选项，并在相应的数字键。';
...
%观点采择perspective-taking
PT=[3 8 11 15 21 25 28];
%幻想fantasy
FS=[1 5 7 12 16 23 26];
%共情关注empathic concern
EC=[2 4 9 14 18 20 22];
%个人悲伤personal distress
PD=[6 10 13 17 19 24 27];
% 反向记分题
invr = [3 4 7 12 13 14 15 18 19];
